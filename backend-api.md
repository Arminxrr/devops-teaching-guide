...
* ห้ามใช้ ORM (เช่น Sequelize, TypeORM) - ต้องเขียน SQL queries เอง
* ห้ามใช้ ready-made authentication packages
* ห้ามคัดลอกโค้ดจากอินเทอร์เน็ต มากกว่า 10 บรรทัด
...
เริ่มต้นได้เลย! ขอให้สนุกกับการเขียนโค้ด&#x20;

หากติดปัญหาระหว่างทำ สามารถถามคำแนะนำได้
