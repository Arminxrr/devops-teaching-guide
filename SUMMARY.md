...
* [บทที่ 7 -Backend](7-backend/README.md)
  * [โครงสร้าง Backend](7-backend/backend.md)
  * [สร้าง DataBase เเละ การสร้าง table](7-backend/database-table.md)
  * [สร้างเส้น Login API เเละใช้ postman](7-backend/login-api-postman.md)
  * [ทำ Login + JWT Token](7-backend/login-+-jwt-token.md)
  * [ทำเส้นดูข้อมูลตัวเองจาก token](7-backend/token.md)
* [บทที่ 8 Node RED](8-node-red/README.md)
  * [โครงสร้างการทำงาน](8-node-red/undefined.md)
  * [Backend API](8-node-red/backend-api.md)
  * [ESP 32 dhtt 11](8-node-red/esp-32-dhtt-11.md)
  * [วิธีการใช้ Node Red](8-node-red/node-red.md)
